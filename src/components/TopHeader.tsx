...
export function TopHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border/50 bg-white/70 backdrop-blur-xl px-4">
      <SidebarTrigger className="shrink-0" />

      <div className="relative flex-1 max-w-xl">
        <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
        <Input
          placeholder="Search files, meetups, forums..."
          value={search}
